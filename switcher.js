var skins = ["asciidoctor", "clean", "dark", "fedora", "gazette", "italian-pop", "medium", "monospace", "notebook", "plain", "tufte", "ubuntu", "material-amber", "material-blue", "material-brown", "material-green", "material-grey", "material-orange", "material-pink", "material-purple", "material-red", "material-teal", "boot-cerulean", "boot-cosmo", "boot-cyborg", "boot-darkly", "boot-flatly", "boot-journal", "boot-lumen", "boot-paper", "boot-readable", "boot-slate", "boot-spacelab", "boot-superhero", "boot-yeti", "template"]
